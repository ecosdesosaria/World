...
namespace Server
{
	...
	public class ItemSalesInfo
	{
		...
		public static ItemSalesInfo[] m_SellingInfo = new ItemSalesInfo[]
		{
			...
			new ItemSalesInfo( typeof(	Artifact_TalismanOfTheAlbatroz	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
			...
			new ItemSalesInfo( typeof(	XormiteIngot	),	25	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Smith	),
			...
			new ItemSalesInfo( typeof(	NeuraniumIngot	),	225,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Smith	),
			...
			new ItemSalesInfo( typeof(	DemonSkins	),	66	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	DragonSkins	),	66	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	NightmareSkins	),	33	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	SnakeSkins	),	33	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	TrollSkins	),	33	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	UnicornSkins	),	55	,	0	,	80	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	DeadSkins	),	11	,	0	,	90	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	IcySkins	),	22	,	0	,	90	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
			new ItemSalesInfo( typeof(	LavaSkins	),	22	,	0	,	90	,	false	,	false	,	World.None	,	Category.Resource	,	Material.None	,	Market.Leather	),
