...
namespace Server.Items
{
	...
	public class StealingBoard : Item
	{
		...
		public override void OnDoubleClick( Mobile e )
		{
			...
			{
				e.SendMessage( "Esta placa parece estar escrita em algum tipo de gíria de ladrões." );
			}
			else if ( e.InRange( this.GetWorldLocation(), 4 ) )
			{
				...
				string sText = "Há aqueles com grande riqueza que buscam itens que supostamente estão dentro das masmorras da terra. Esses nobres procuram um ladrão astuto para se infiltrar nesses lugares e encontrar esses itens. Encontre-os, roube-os e venda-os ao Mestre da Guilda de Ladrões para receber seu pagamento.<br><br>";
				...
				sText = sText + "Esses itens raros podem nem sempre estar lá. Um ladrão mais habilidoso pode tê-lo alcançado antes, e você pode ser forçado a esperar que ele reapareça. Portanto, o tempo é essencial se você quiser lucrar com a ansiedade da realeza.";
