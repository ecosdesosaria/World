	...
	public class LearnReagentsBook : Item
	{
		...
		public class LearnReagentsGump : Gump
		{
			public LearnReagentsGump( Mobile from ): base( 50, 50 )
			{
				...
				AddHtml( 237, 62, 434, 707, @"<BODY><BASEFONT Color=" + color + ">Magos, necromantes, bruxas, alquimistas e druidas usam reagentes de algum tipo. Esta é uma lista dos tipos de reagentes que você pode encontrar enquanto viaja pelo mundo. Esta não é uma lista completa, pois lendas e rumores contam de outros tipos que podem existir. Reagentes podem ser comprados de mercadores, colhidos de alguns jardins, encontrados em algumas criaturas ou descobertos com outros tesouros. É comum encontrar reagentes que possam ser usados em seu ofício atual, mas se não tiver tal ofício, então pode encontrar qualquer tipo que possa deixar para trás ou vender.<br><br>Magos usam os reagentes comuns na conjuração de feitiços, enquanto necromantes usam os reagentes de necromancia para sua magia. Bruxas e druidas também usam alguns desses reagentes listados aqui.<br><br>Você pode encontrar muitos reagentes que precisa identificar. Se você praticou sua degustação, será capaz de descobrir o que são. Magos e necromantes simplesmente carregam os reagentes com eles para usar ao lançar feitiços. Alquimistas usam um almofariz e pilão para criar poções, enquanto bruxas e druidas usam caldeirões.</BASEFONT></BODY>", (bool)false, (bool)false);
			}
