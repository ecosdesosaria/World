...
namespace Server.Items
{
    ...
    public class TavernGump : Gump
    {
        ...
        public TavernGump( Mobile from, TavernTable table ): base( 50, 50 )
        {
			...
			AddHtml( 12, 14, 416, 20, @"<BODY><BASEFONT Color=" + color + ">MESAS DE TAVERNA</BASEFONT></BODY>", (bool)false, (bool)false);

			AddHtml( 14, 46, 461, 291, @"<BODY><BASEFONT Color=" + color + ">Mesas de taverna são pequenas mesas de bebida que você pode colocar em sua casa. Quando devidamente travadas, você pode configurar a mesa para o número de frequentadores que ficarão ao lado da mesa. Estes frequentadores serão aventureiros aleatórios, buscando refúgio temporário em sua casa. Eles não oferecem nenhum benefício, exceto fazer companhia e contar breves ou vagas histórias de aventura. De vez em quando, os aventureiros seguirão seu caminho e outros tomarão seu lugar para descansar. Simplesmente marque as caixas próximas ao ícone da mesa, onde você deseja que os frequentadores fiquem.<br><br>Lembre-se, estes frequentadores não o ajudarão em suas missões como os cidadãos que você encontra nas vilas e cidades. Eles não consertarão seus itens, venderão itens incomuns ou contarão aleatoriamente a outros onde uma relíquia especial ou personagem está localizada. Eles simplesmente proporcionam à sua casa um pouco de atmosfera. Colocar muitas mesas com muitos frequentadores não o ajudará a encontrar a localização de Exodus ou o último local conhecido da Vela do Amor. Eles não darão pistas sobre onde você pode encontrar relíquias de museu ou itens necessários para uma missão que você aceitou do diário de um aventureiro morto. Portanto, coloque-os com moderação em sua casa para que você possa ver melhor sobre o que eles podem estar conversando entre si. Por fim, um frequentador sozinho em uma mesa não terá com quem conversar, então se você quiser que eles conversem, certifique-se de ter pelo menos dois frequentadores por mesa.</BASEFONT></BODY>", (bool)false, (bool)true);
