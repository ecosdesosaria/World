...
{
	[CorpseName( "Cadáver de Sharon" )]
	public class Sharon : BaseCreature
	{
		[Constructable]
		public Sharon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Sharon";
			Body = 149;
			BaseSoundID = 0x4B0;
			...
			SetSkill( SkillName.Psychology, 125.0, 125.0 );
			SetSkill( SkillName.Magery, 125.0, 125.0 );
			SetSkill( SkillName.Meditation, 125.0, 125.0 );
		...
		public void DrainLife()
		{
			...
			foreach ( Mobile m in list )
			{
				...
				m.SendMessage( "Você sente a vida saindo de você!" );

				int toDrain = Utility.RandomMinMax( 40, 70 );
		...
		public Sharon( Serial serial ) : base( serial )
		{
		}
