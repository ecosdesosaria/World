...
{ 
	public class AncientSpellbookGump : Gump 
	{
		...
		public AncientSpellbookGump( Mobile from, AncientSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			{
				info = "Este livro será apenas seu para usar e você só pode ter um livro por vez. Criar um novo livro fará com que este livro se desfaça em pó. Usar livros de feitiços antigos exige que o conjurador carregue reagentes consigo. As páginas do livro também podem virar pó quando os feitiços são lançados, então o mago precisará manter páginas extras (pergaminhos em branco) dentro do livro. Eles também precisarão manter penas (penas de escriba) reservadas. Simplesmente coloque esses itens neste livro para manter um suprimento de cada. Se você ficar sem, não poderá lançar nenhum feitiço até adquirir mais. Você pode achar que não consome nenhum pergaminho ou pena quando existem atributos de redução de reagente. Esses livros podem ser equipados como outros livros de feitiços.<BR><BR>" + Server.Misc.ResearchSettings.BagOrBook() + "<BR><BR>Os feitiços são lançados com aqueles habilidosos em magia ou necromancia, o que for maior. A eficácia dos feitiços depende da combinação de magia, necromancia, espiritualismo e psicologia. Se você é habilidoso apenas em algumas dessas habilidades, os feitiços terão apenas um efeito médio. São aqueles que buscam todas as quatro habilidades da feitiçaria que obterão o maior benefício. Quando os feitiços antigos são realizados, isso ajuda um pesquisador a praticar inscrição, magia, necromancia, espiritualismo e psicologia ao mesmo tempo. É por isso que a pesquisa de feitiços antigos interessa aos arquimagos, pois eles alcançaram o nível de grão-mestre em ambas as áreas da magia. Algumas magias antigas têm semelhanças com feitiços usados hoje, como é de se esperar que parte do conhecimento tenha sobrevivido através das eras. Portanto, muito poucos feitiços serão semelhantes aos feitiços de magia atuais, e ainda menos feitiços semelhantes aos feitiços necromantes modernos. Embora sejam semelhantes, o feitiço antigo geralmente se mostra muito mais poderoso.";

				AddHtml( 78, 80, 250, 314, @"<BODY><BASEFONT Color=" + color + ">" + info + "</BASEFONT></BODY>", (bool)false, (bool)true);

				info = "Barras de Ferramentas Mágicas: Aqui estão os comandos que você pode usar (inclua o colchete) para gerenciar barras de ferramentas mágicas que podem ajudá-lo a jogar melhor.<BR><BR>[ancient - Alterna entre usar o livro ou a bolsa.<BR><BR>[archspell1 - Abre o 1º editor de barra de feitiços antigos.<BR><BR>[archspell2 - Abre o 2º editor de barra de feitiços antigos.<BR><BR>[archspell3 - Abre o 3º editor de barra de feitiços antigos.<BR><BR>[archspell4 - Abre o 4º editor de barra de feitiços antigos.<BR><BR>[archtool1 - Abre a 1ª barra de feitiços antigos.<BR><BR>[archtool2 - Abre a 2ª barra de feitiços antigos.<BR><BR>[archtool3 - Abre a 3ª barra de feitiços antigos.<BR><BR>[archtool4 - Abre a 4ª barra de feitiços antigos.<BR><BR>[archclose1 - Fecha a 1ª barra de feitiços antigos.<BR><BR>[archclose2 - Fecha a 2ª barra de feitiços antigos.<BR><BR>[archclose3 - Fecha a 3ª barra de feitiços antigos.<BR><BR>[archclose4 - Fecha a 4ª barra de feitiços antigos.<BR><BR>Abaixo estão os comandos [ que você pode digitar para lançar rapidamente um feitiço específico, ou configurar uma tecla de atalho para emitir este comando e lançar o feitiço." + Server.Misc.ResearchSettings.AncientKeywords() + "";
