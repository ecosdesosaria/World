...
namespace Server.Items
{
    ...
    public class ExplainShopped : Gump
    {
        ...
        public ExplainShopped( Mobile from, Mobile merchant ): base( 50, 50 )
        {
			...
			AddHtml( 11, 11, 200, 20, @"<BODY><BASEFONT Color=" + color + ">CONFIGURAR LOJA</BASEFONT></BODY>", (bool)false, (bool)false);
			AddHtml( 13, 44, 582, 437, @"<BODY><BASEFONT Color=" + color + ">Então desejas configurar uma Loja própria. Para isso, precisarás de tua própria casa construída em algum lugar nas terras. Estas Lojas geralmente exigem que te separes de 10.000 peças de ouro, mas podem rapidamente pagar-se a si mesmas se fores bom na tua arte. Só podes ter um tipo desta Loja em qualquer momento. Serás o único a usar a Loja, mas podes dar permissão a outros para transferirem o ouro para um cheque bancário para si mesmos. Lojas precisam ser abastecidas com ferramentas e recursos, e a Loja indicará quais são esses. Simplesmente deixa cair tais coisas na tua Loja para acumular um inventário. Quando deixares cair ferramentas na tua Loja, o número de usos das ferramentas será adicionado à contagem de ferramentas da Loja. Uma Loja só pode conter 1.000 ferramentas e 5.000 recursos. Estes serão usados à medida que realizas tarefas para outros. Após um período determinado de tempo, clientes farão pedidos que podes cumprir ou recusar. Cada pedido exibirá a tarefa, para quem é, a quantidade de ferramentas necessárias, a quantidade de recursos requeridos, tua chance de cumprir o pedido (baseada na dificuldade e na tua habilidade), e a quantidade de reputação que tua Loja adquirirá se fores bem-sucedido.<br><br>Se falhares em realizar uma tarefa selecionada, ou recusares fazê-la, a reputação da tua Loja cairá pelo mesmo valor que terias sido recompensado. O boca a boca viaja rápido nas terras e terás trabalho menos prestigioso se tua reputação for baixa. Se te encontrares a atingir os baixos de te tornares um assassino, tua Loja será inútil pois ninguém negocia com assassinos. Qualquer ouro ganho permanecerá dentro da Loja até que cliques uma vez na Loja e Transferires os fundos para fora dela. Tua Loja não pode ter mais de 500.000 peças de ouro de cada vez, e não poderás conduzir mais negócios nela até retirares os fundos para que possa acumular mais. A reputação da Loja não pode descer abaixo de 0, e não pode subir acima de 10.000. Novamente, quanto maior a reputação, mais trabalho lucrativo te será pedido para fazer. Se és membro da guilda de artesanato associada, tua reputação terá um bónus baseado na tua habilidade de artesanato. Se tens ouro suficiente na tua mochila, desejas que construa uma Loja para ti?</BASEFONT></BODY>", (bool)false, (bool)true);
    ...
    public class ShoppeGump : Gump
    {
        ...
        public ShoppeGump( BaseShoppe shoppe, Mobile from ): base( 50, 50 )
        {
			...
			{
				string mercrate = "<br><br>Se desejas ganhar mais ouro com tua casa, vê o fornecedor local e vê se podes comprar uma caixa de mercador. Estas caixas permitem-te criar itens, colocá-los na caixa, e a Guilda de Mercadores irá recolher tuas mercadorias após um período determinado de tempo. Se decides que queres algo de volta da caixa, certifica-te de retirá-lo antes que a guilda apareça.";

				if ( !MySettings.S_MerchantCrates )
					mercrate = "";

				AddHtml( 11, 11, 532, 20, @"<BODY><BASEFONT Color=" + color + ">SOBRE LOJAS</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 13, 44, 879, 360, @"<BODY><BASEFONT Color=" + color + ">O mundo está cheio de oportunidades, onde aventureiros buscam a ajuda de outros para alcançar seus objetivos. Com bolsas de moedas cheias, eles procuram especialistas em vários ofícios para adquirir suas habilidades. Alguns precisariam de armaduras reparadas, mapas decifrados, poções preparadas, pergaminhos traduzidos, roupas consertadas, ou muitas outras coisas. Os mercadores, nas cidades e vilas, frequentemente não conseguem acompanhar a demanda desses pedidos. Isto proporciona oportunidade para aqueles que praticam um comércio e têm sua própria casa de onde conduzir negócios. Procura um comerciante e vê se eles têm uma opção para construírem uma Loja para ti. Estas Lojas geralmente exigem que te separes de 10.000 peças de ouro, mas podem rapidamente pagar-se a si mesmas se fores bom na tua arte. Só podes ter um tipo de cada Loja em qualquer momento. Então, se és habilidoso em dois tipos diferentes de ofícios, podes ter uma Loja para cada. Serás o único a usar a Loja, mas podes dar permissão a outros para transferirem o ouro para um cheque bancário para si mesmos. Lojas precisam ser abastecidas com ferramentas e recursos, e a Loja indicará quais são esses na base. Simplesmente deixa cair tais coisas na tua Loja para acumular um inventário. Quando deixares cair ferramentas na tua Loja, o número de usos das ferramentas será adicionado à contagem de ferramentas da Loja. Uma Loja só pode conter 1.000 ferramentas e 5.000 recursos. Após um período determinado de tempo, clientes farão pedidos que podes cumprir ou recusar. Cada pedido exibirá a tarefa, para quem é, a quantidade de ferramentas necessárias, a quantidade de recursos requeridos, tua chance de cumprir o pedido (baseada na dificuldade e na tua habilidade), e a quantidade de reputação que tua Loja adquirirá se fores bem-sucedido.<br><br>Se falhares em realizar uma tarefa selecionada, ou recusares fazê-la, a reputação da tua Loja cairá pelo mesmo valor que terias sido recompensado. O boca a boca viaja rápido nas terras e terás trabalho menos prestigioso se tua reputação for baixa. Se te encontrares a atingir os baixos de te tornares um assassino, tua Loja será inútil pois ninguém negocia com assassinos. Qualquer ouro ganho permanecerá dentro da Loja até que cliques uma vez na Loja e Transferires os fundos para fora dela. Tua Loja não pode ter mais de 500.000 peças de ouro de cada vez, e não poderás conduzir mais negócios nela até retirares os fundos para que possa acumular mais. A reputação da Loja não pode descer abaixo de 0, e não pode subir acima de 10.000. Novamente, quanto maior a reputação, mais trabalho lucrativo te será pedido para fazer. Se és membro da guilda de artesanato associada, tua reputação terá um bónus baseado na tua habilidade de artesanato." + mercrate + "</BASEFONT></BODY>", (bool)false, (bool)true);
				...
				AddHtml( 153+i, 348+o, 717, 20, @"<BODY><BASEFONT Color=" + color + ">Mostra o ouro da tua loja no topo, ou para cada contrato individual.</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 153+i, 378+o, 717, 20, @"<BODY><BASEFONT Color=" + hilit + ">Mostra a contagem de ferramentas da tua loja no topo, ou ferramentas necessárias para cada contrato individual.</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 153+i, 408+o, 717, 20, @"<BODY><BASEFONT Color=" + color + ">Mostra a contagem de recursos da tua loja no topo, ou recursos necessários para cada contrato individual.</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 153+i, 438+o, 717, 20, @"<BODY><BASEFONT Color=" + hilit + ">Mostra teu bónus de reputação se és membro da guilda associada.</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 153+i, 468+o, 717, 20, @"<BODY><BASEFONT Color=" + color + ">Mostra tua chance de cumprir com sucesso um contrato.</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 153+i, 498+o, 717, 20, @"<BODY><BASEFONT Color=" + hilit + ">Mostra a reputação da tua loja no topo, ou para cada contrato individual.</BASEFONT></BODY>", (bool)false, (bool)false);

				AddImage(108+i, 538+o, 4023);
				AddImage(108+i, 594+o, 4020);
				AddHtml( 153+i, 536+o, 717, 40, @"<BODY><BASEFONT Color=" + color + ">Isto tentará cumprir o contrato. Se falhares, perderás materiais e reputação. Se tiveres sucesso, ganharás reputação e ouro, além de usar os materiais apropriados.</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 153+i, 595+o, 717, 20, @"<BODY><BASEFONT Color=" + hilit + ">Isto recusará o pedido, mas sofrerás uma redução na reputação da tua loja ao fazê-lo.</BASEFONT></BODY>", (bool)false, (bool)false);
			}
			else
			{
