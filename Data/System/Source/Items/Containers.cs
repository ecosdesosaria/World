...
namespace Server.Items
{
	public class BankBox : Container
	{
		...
		public void Open()
		{
			...
			if ( m_Owner != null )
			{
				m_Owner.PrivateOverheadMessage( MessageType.Regular, 0x3B2, true, String.Format( "Seu armazenamento bancário tem {0} itens, {1} pedras", (TotalItems), (TotalWeight) ), m_Owner.NetState );
